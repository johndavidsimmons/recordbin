...
class TestLoginLogout(SeleniumTestBase):
    ...
    def tearDown(self):
        db.session.remove()
        db.drop_all()
        # call parent tearDown method in SeleniumTestBase class
        super(TestLoginLogout, self).tearDown()

    @screenshot_exceptions
    def test_user_login(self):
        ''' test successful login functionality through login form '''
        login_user(self.test_user.email, self.test_user_password)
    ...
    def test_nonexistent_user_login(self):
        ...
        login_user('idontexist@test.com', 'test')
    ...
    def test_user_login_form_validation(self):
        ...
        # test no password
        login_user(self.test_user.email, '')
        ...
        login_user(self.test_user.email, '1')
...
class TestPasswordManagement(SeleniumTestBase):
    ...
    def tearDown(self):
        db.session.remove()
        db.drop_all()
        super(TestPasswordManagement, self).tearDown()
